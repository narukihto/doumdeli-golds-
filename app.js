...
// ==========================================
// تم استبدال مسارات الصور المحلية بروابط إنترنت حقيقية لتعمل الصور فوراً بموقعك
...
// ==========================================
// تم إصلاح الرابط هنا وتحديثه للرابط المباشر والسريع والمضمون للواتساب wa.me لفتح التطبيق فوراً
function submitCosmicOrder(event) {
    ...
    // استخدام الرابط المباشر والأسرع للواتساب لتجنب مشاكل المتصفحات والتطبيقات المعلقة
